...
export class LayoutSettingsController {
  ...
  constructor() {
    ...
    window.minimalInterfaceCheckbox.addEventListener("change", () => {
      window.vms.self.setMinimalInterfaceMode(
        window.minimalInterfaceCheckbox.checked
      );
    });
  }
